...
func _layout() -> void:
	...
	_buttons = [
		_mk(base + Vector2(0, 0), r * 1.15, "pickup", "拿/放", Color(1.0, 0.78, 0.15)),
		_mk(base + Vector2(-r * 2.5, r * 0.15), r, "interact", "交互", Color(0.45, 0.8, 1.0)),
		...
		_mk(Vector2(s.x - 108.0, 44.0), 26.0, "site_map", "地图", Color(0.85, 0.85, 0.85)),
		_mk(Vector2(s.x - 172.0, 44.0), 26.0, "task_list", "任务", Color(0.85, 0.85, 0.85)),
	]
	queue_redraw()
