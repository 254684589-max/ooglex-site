...
生成物约 1.5MB，放在 godot/assets/fonts/NotoSansSC-WL.ttf。以后在代码里新增了
生僻字，重新跑一次本脚本即可。

用法：
    pip install fonttools   # 仅本地构建需要，不是网站依赖
    python3 games/working-life/tools/build_font.py path/to/NotoSansSC[wght].ttf
...
OUT = GODOT / "assets" / "fonts" / "NotoSansSC-WL.ttf"
SOURCE_SUFFIXES = {".gd", ".tscn", ".godot", ".cfg", ".tres", ".json"}
WEIGHT = 500
