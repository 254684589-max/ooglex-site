...
(function (global) {
  ...
  var FUNCTIONS = [
    ...
    { mn:"DESC", zh:"证券描述", en:"Security Description", cat:"anly", status:"live",
      href:"/apps/finance-terminal/security.html",
      data:["companies/data.json","companies/history.json","companies/intraday.json"],
      note:"单证券的发行人、证券、标识、收益、走势与口径分页" },
    { mn:"COMP", zh:"多标的比较", en:"Comparative Returns", cat:"anly", status:"live",
      href:"/apps/finance-terminal/compare.html",
      data:["companies/data.json","companies/history.json","asset-tracker/data.json","asset-tracker/history.json"],
      note:"按日期对齐、共同窗口内重基到 100 叠加比较；另给价差比值、回撤与区间总回报" },
    { mn:"TRND", zh:"榜单与趋势", en:"Trends", cat:"anly", status:"live",
      href:"/apps/finance-terminal/trends.html", data:["companies/data.json","whats-latest/data.json"],
      note:"可切六个维度的排行表，编号行 + 相对强弱 + 迷你走势" },
    { mn:"QUOT", zh:"行情详情", en:"Quote Detail", cat:"quote", status:"live",
      href:"/apps/finance-terminal/quote.html", data:["asset-tracker/data.json"],
      note:"单标的完整走势：日线 1 个月至全部区间，有小时观测的另有 4 小时线" },
    ...
    /* ── 系统 ──────────────────────────────────────────────────────────── */
    { mn:"FDIR", zh:"功能目录", en:"Function Directory", cat:"sys", status:"live",
      href:"#fdir", data:[], note:"本注册表本身，列出已接入与规划中的全部功能" },
    { mn:"HELP", zh:"帮助", en:"Help", cat:"sys", status:"live",
      href:"#help", data:[], note:"键盘与命令行说明" },
    { mn:"OLD",  zh:"旧版终端", en:"Legacy Terminal", cat:"sys", status:"live",
      href:"/apps/finance-terminal/legacy.html", data:["站内各应用"],
      note:"改版前的终端页，保留可用；其品类看板与地缘风险模块尚未迁入新版" }
  ];
  ...
  var PLANNED = [
    ...
    { mn:"L2",   zh:"逐笔报价与深度", en:"Level 1/2 Quotes", cat:"quote",
