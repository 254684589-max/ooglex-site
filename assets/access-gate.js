...
(function () {
  ...
  function addStyles() {
    ...
    style.textContent =
      ...
      "#ooglex-registration-preview{position:relative;z-index:2147483646;box-sizing:border-box;width:100%;min-height:218px;padding:24px 20px 22px;text-align:center;background:#171717;color:#f5f5f5;border-top:1px solid rgba(255,255,255,.10);box-shadow:0 -18px 50px rgba(0,0,0,.30);font-family:-apple-system,BlinkMacSystemFont,'PingFang SC','Microsoft YaHei','Segoe UI',sans-serif}" +
  ...
  (async function () {
    ...
    try {
      document.dispatchEvent(new CustomEvent("ooglex:accessready", {
        detail: { authenticated: ok, previewRatio: PREVIEW_RATIO, style: "supply-chain-block-v2" }
      }));
    } catch (_) {}
  })();
})();