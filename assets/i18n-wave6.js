...
(function () {
  ...
  var TECH_LEADERS = {
    ...
    "系统分享": "System share",
    "分享原文": "Share original text",
    "微信分享": "Share via WeChat",
    ...
    "“分享原文”只发送这条动态的原生正文，不附带网址；需要链接时使用“复制帖子链接”。": "“Share original text” sends only the native post text with no URL. Use “Copy post link” when you need a link.",
    "“分享原文”只发送这条动态的原生正文；“微信分享”会准备专用链接并尝试打开微信，在微信内打开后可通过右上角“…”继续分享。": "“Share original text” sends only the native post text. “Share via WeChat” prepares a dedicated link and tries to open WeChat; after opening the link in WeChat, use the top-right menu to continue sharing.",
    "单条动态": "Single post",
