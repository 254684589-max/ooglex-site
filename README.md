...
- **数据每日自动更新**：`.github/workflows/asset_ranking.yml` 每天 23:40 UTC（排在 companies 之后）跑
...
- **数据每日自动更新**：`.github/workflows/asset_tracker.yml` 每天 22:30 UTC（美股收盘后）跑
...
- **数据每日自动更新**：`.github/workflows/billionaires.yml` 每天 22:50 UTC 跑
...
- **数据每日自动更新**：`.github/workflows/companies.yml` 每天 23:10 UTC 跑
...
- **数据每日自动更新**：`.github/workflows/fear_greed.yml` 每天 23:10 UTC 跑
...
- **数据每日自动更新**：`.github/workflows/world_economy.yml` 每天 23:40 UTC 跑
...
- **数据每日自动更新**：`.github/workflows/movies.yml` 每天 00:20 UTC 跑 `scripts/movies/build_movies.py`，
...
- **数据每日自动更新**：`.github/workflows/econ_calendar.yml` 每天 00:30 与 12:30 UTC 跑两次
